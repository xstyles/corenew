...
class CW_Field_RadioGroup_Ex extends GF_Field_Radio
{
    public $type = 'radio-ex';

    public function get_form_editor_field_title()
    {
        // return esc_attr__('Radio Buttons', 'gravityforms');
        return 'Radio buttons group for Repeater';
    }
...
GF_Fields::register( new CW_Field_RadioGroup_Ex() );