jQuery( function ( $ ) {
    ...
    var $groups_list = $('#bpmtp-selected-groups-list');
    var $group_selector_field =  $("#bpmtp-group-selector");
    ...
    $group_selector_field.autocomplete({
        ...
        select: function(e, ui) {
            ...
            var $li = "<li>" +
                "<input type='hidden' value='" + ui.item.id + "' name='_bp_member_type_groups[]'/>" +
    ...
    //remove
    $groups_list.on( 'click', '.bpmtp-remove-group', function() {
        $(this).parent().remove();
        return false;
    });
