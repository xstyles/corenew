...
class SmartSlider3Info {
    ...
    public static $version = '3.5.0.7';

    public static $channel = 'stable';

    public static $revision = '8760d5466a76adbdee5141d36167ebd67d049906';

    public static $revisionShort = '8760d546';

    public static $branch = 'release-3.5.0.7';
